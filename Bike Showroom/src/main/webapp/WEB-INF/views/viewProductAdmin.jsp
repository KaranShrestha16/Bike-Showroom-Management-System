             ...
             <table id="example1" class="table table-bordered table-striped">
               ...
               <c:forEach var="product" items="${slist}">
                <tr>
                  ...
                  <td>
				<input type="button" class="btn btn-success" onclick="editProductByAdmin(${product.product_id})" value="Edit">
				<input type="button" class="btn btn-danger" onclick="deleteProduct(${product.product_id})" value="Delete">
				</td>
...
<script type="text/javascript">
	function editProductByAdmin(id){
		window.location="${pageContext.request.contextPath}/"+id+"/editProductByAdmin";
	}
