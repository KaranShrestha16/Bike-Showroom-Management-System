       ...
       <li class=" treeview menu-open">
         ...
         <li class="active treeview menu-open">
          ...
          <ul class=" treeview-menu">
            ...
            <li class="active"><a href="viewPurchaseStaff"><i class="fa fa-circle-o"></i> View Purchase</a></li>
          </ul>
        </li>
               ...
               <c:forEach var="purchase" items="${slist}">
                <tr>
                 ...
                 <td>${purchase.productName}</td>
                  ...
                  <td>
				<input type="button" class="btn btn-success" onclick="editPurchaseByStaff(${purchase.purchase_id})" value="Edit">
					</td>
...
<script type="text/javascript">
	function editPurchaseByStaff(id){
		window.location="${pageContext.request.contextPath}/"+id+"/editPurchaseByStaff";
	}
