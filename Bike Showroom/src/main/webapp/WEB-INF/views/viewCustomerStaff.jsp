...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="staffDashboard" dashboard class="logo">
       ...
       <li class=" treeview menu-open">
         ...
         <li class=" treeview menu-open">
          ...
          <ul class="active treeview-menu">
            ...
            <li class="active"><a href="viewCustomerStaff"><i class="fa fa-circle-o"></i> View Customer</a></li>
          </ul>
        </li>
              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               <c:forEach var="customer" items="${slist}">
                <tr>
                  ...
                  <td>
				<input type="button" class="btn btn-success" onclick="editCustomer(${customer.customer_id})" value="Edit">
					</td>
...
<script type="text/javascript">
	function editCustomer(id){
		window.location="${pageContext.request.contextPath}/"+id+"/editCustomerStaff";
	}
	function deleteCustomer(id){
		var msg=confirm("do you want to delete ? ");
		if(msg==true){
			window.location="${pageContext.request.contextPath}/"+id+"/deleteCustomerStaff";
		}
	}
