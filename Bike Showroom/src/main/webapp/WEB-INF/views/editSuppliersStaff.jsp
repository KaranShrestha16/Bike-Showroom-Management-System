...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
     ...
     <img src="${pageContext.request.contextPath}/resources/images/${imageName}" height="50" width="50"  class="img-circle" width="120px"  height="120px" alt="User Image" >
          </div>
         ...
         <li class="treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li> <a href="${pageContext.request.contextPath}/viewSuppliersStaff"><i class="fa fa-circle-o"></i> View Supplier</a></li>
             <li class="active"> <a href="${pageContext.request.contextPath}/editSuppliersStaff"><i class="fa fa-circle-o"></i> Edit Supplier</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="${pageContext.request.contextPath}/addCustomer">Supplier</a></li>
         <li><a> Edit Supplier</a></li>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12" >
            <form action="${pageContext.request.contextPath}/updateSupplier" method="post" enctype="multipart/form-data">
              <div class="box-body">
