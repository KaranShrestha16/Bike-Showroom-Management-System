   ...
   <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="  treeview menu-open">
         ...
         <li class=" active treeview menu-open">
          <a href="${pageContext.request.contextPath}/addSales">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a><i class="fa fa-circle-o"></i> Edit Sales</a></li>
          </ul>
        </li>      
        
           
         <li class=" treeview menu-open">
          <a href="${pageContext.request.contextPath}/purchaseReoprt">
         ...
         <li class=" treeview menu-open">
          <a href="${pageContext.request.contextPath}/generateBill">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12" >
            <form action="${pageContext.request.contextPath}/updateSalesByStaff" method="post" enctype="multipart/form-data">
              <div class="box-body">
              <div class="col-xs-10">
