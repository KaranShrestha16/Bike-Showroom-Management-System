  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Staff Profile Form</li>
      </ol>
    </section>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
             ...
             <form action="${pageContext.request.contextPath}/updateStaffProfileByStaff" method="post" enctype="multipart/form-data">
           
             <div class="col-xs-4"></div>
                <div  class="col-xs-6">
             
              <div>
               <img src="${pageContext.request.contextPath}/resources/images/${staff.imageName}" height="150" width="150" class="img-circle" alt="User Image" >
