  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="addAdmin">View Admin</li>
      </ol>
    </section>
         ...
         <div class="box">
            ...
            <div class="box-body">
             <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
               <c:forEach var="admin" items="${slist}">
                <tr>
                  <td>${admin.admin_id}</td>
                  <td>${admin.fullName}  </td>
                  <td>${admin.email}</td>
                  <td>
				<input type="button" class="btn btn-success" onclick="editAdmin(${admin.admin_id})" value="Edit">
				<input type="button" class="btn btn-danger" onclick="deleteAdmin(${admin.admin_id})" value="Delete">
				</td>
