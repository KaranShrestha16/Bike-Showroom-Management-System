  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="addSuppliersStaff">Purchase</a></li>
        <li >View Purchase</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
             <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
               <c:forEach var="purchase" items="${slist}">
                <tr>
                 ...
                 <td>${purchase.productName}</td>
                  ...
                  <td>
				<input type="button" class="btn btn-success" onclick="editPurchaseByAdmin(${purchase.purchase_id})" value="Edit">
				<input type="button" class="btn btn-danger" onclick="deletePurchaseByAdmin(${purchase.purchase_id})" value="Delete">
					</td>
...
<script type="text/javascript">
	function editPurchaseByAdmin(id){
		window.location="${pageContext.request.contextPath}/"+id+"/editPurchaseByAdmin";
	}
	function deletePurchaseByAdmin(id){
		var msg=confirm("do you want to delete ? ");
		if(msg==true){
		window.location="${pageContext.request.contextPath}/"+id+"/deletePurchaseByAdmin";
		}
	}
