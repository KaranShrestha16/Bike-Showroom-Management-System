       ...
       <li class="  treeview menu-open">
         ...
         <li class=" active treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active" ><a href="${pageContext.request.contextPath}/viewCustomerStaff"><i class="fa fa-circle-o"></i> Edit Customer</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="${pageContext.request.contextPath}/addCustomer">Customer</a></li>
        <li><a href="${pageContext.request.contextPath}/addCustomer">Edit Customer</a></li>
