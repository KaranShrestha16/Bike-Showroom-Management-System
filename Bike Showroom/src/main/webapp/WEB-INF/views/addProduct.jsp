   ...
   <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="  treeview menu-open">
         ...
         <li class=" treeview menu-open">
          ...
          <ul class="treeview-menu">
		    <li class="active" ><a href="addProduct"><i class="fa fa-circle-o"></i> Add Product</a></li> 
              ...
              <div class="box-body">
               ...
               <div class="col-xs-5">
				...
				<div class="col-xs-5">
                 ...
                 <div class="input-group">
	                <span class="input-group-addon">@</span>
	                <input type="text" name="color" class="form-control" placeholder="Enter Product Color"  required >
