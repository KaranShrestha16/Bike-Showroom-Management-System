       ...
       <li class=" treeview menu-open">
         ...
         <li class=" treeview menu-open">
          ...
          <li ><a href="addProduct"><i class="fa fa-circle-o"></i> Add Product</a></li>
            <li class="active"><a href="viewProductStaff"><i class="fa fa-circle-o"></i> View Product</a></li>
          </ul>
        </li>
             ...
             <table id="example1" class="table table-bordered table-striped">
               ...
               <c:forEach var="product" items="${slist}">
                <tr>
                  ...
                  <td>
				<input type="button" class="btn btn-success" onclick="editProduct(${product.product_id})" value="Edit">
				</td>
...
<script type="text/javascript">
	function editProduct(id){
		window.location="${pageContext.request.contextPath}/"+id+"/editProduct";
	}
	function deleteProduct(id){
		var msg=confirm("do you want to delete ? ");
		if(msg==true){
			window.location="${pageContext.request.contextPath}/"+id+"/deleteProduct";
		}
	}
