      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
       ...
       <li class="  treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active" > <a href="viewStaff"><i class="fa fa-circle-o"></i> View Staff</a></li>
          </ul>
        </li>
              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               <c:forEach var="staff" items="${slist}">
                <tr>
                  ...
                  <td>${staff.address}</td>
                  <td>${staff.brithDate}</td>
                  <td>${staff.gender}</td>
                  <td>${staff.phone}</td>
                  <td>${staff.salary}</td>
                  <td>${staff.email}</td>
                  <td>
				<input type="button" class="btn btn-success" onclick="editstaff(${staff.id})" value="Edit">
				<input type="button" class="btn btn-danger" onclick="deletestaff(${staff.id})" value="Delete">
				</td>
...
<script type="text/javascript">
	function editstaff(id){
		window.location="${pageContext.request.contextPath}/"+id+"/editstaff";
	}
	function deletestaff(id){
		var msg=confirm("do you want to delete ? ");
		if(msg==true){
			window.location="${pageContext.request.contextPath}/"+id+"/deletestaff";
		}
	}
