        ...
        <li class=" treeview menu-open">
         ...
         <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="viewSalesAdmin"><i class="fa fa-circle-o"></i> View Sales</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="addProduct">Sales</a></li>
               ...
               <c:forEach var="sales" items="${slist}">
                <tr>
                 ...
                 <td>${sales.productName}</td>
                  ...
                  <td>
				<input type="button" class="btn btn-success" onclick="editSalesByAdmin(${sales.sales_id})" value="Edit">
				<input type="button" class="btn btn-danger" onclick="deleteSalesByAdmin(${sales.sales_id})" value="Delete">	
					</td>
...
<script type="text/javascript">
	function editSalesByAdmin(id){
		window.location="${pageContext.request.contextPath}/"+id+"/editSalesByAdmin";
	}
	function deleteSalesByAdmin(id){
		var msg=confirm("do you want to delete ? ");
		if(msg==true){
			window.location="${pageContext.request.contextPath}/"+id+"/deleteSalesByAdmin";
		}
	}
