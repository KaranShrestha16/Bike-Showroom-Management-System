   ...
   <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="  treeview menu-open">
         ...
         <li class=" active treeview menu-open">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="addSales"><i class="fa fa-circle-o"></i> Add Sales</a></li>
          ...
          <div class="row">
			...
			<div class="col-xs-5">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="SalesDate" class="form-control pull-right" id="datepicker" required>
                </div>
                <!-- /.input group -->
              </div>
              ...
              <div class="col-xs-5">
                 ...
                 <div class="input-group">
	                ...
	                <input type="number"  name="salesPrice" id="price" class="form-control"  >
              ...
              <div class="col-xs-5">
                 ...
                 <div class="input-group">
	                <span class="input-group-addon">$</span>
	                <input type="number"  name="vat" id="vat" value="13" class="form-control"  >
	                <span class="input-group-addon">.00</span>
	           </div>
             </div>
              ...
              <div class="col-xs-5">
                 ...
                 <div class="input-group">
	                <span class="input-group-addon">$</span>
	                <input type="text" name="totalSales" id="total"  class="form-control"  >
	                <span class="input-group-addon">.00</span>
	            </div>
