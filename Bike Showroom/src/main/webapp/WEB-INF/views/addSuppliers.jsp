   ...
   <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="  treeview menu-open">
         ...
         <li class=" treeview menu-open">
          ...
          <ul class="treeview-menu">
            <li  class="active"><a  href="addSupplier"><i class="fa fa-circle-o"></i> Add Supplier</a></li>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="addSupplier">Suppliers</a></li>
         <li><a href="addCustomer"> Add Suppliers</a></li>
          ...
          <div class="row">
            ...
            <form action="addSupplier" method="post" enctype="multipart/form-data">
              <div class="box-body">
                 ...
                 <input class="form-control" type="text" name="supplierName" placeholder="Enter Supplier Name" required>
                </div>
   
                 <div class="col-xs-5">
                 <label>Address </label>
                 <input class="form-control" type="text" name="supplierAddress" placeholder="Enter Supplier Address" required>
                </div>
