       ...
       <li class=" treeview menu-open">
         ...
         <li class=" active treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="viewSalesStaff"><i class="fa fa-circle-o"></i> View Sales</a></li>
          </ul>
        </li>      
               ...
               <c:forEach var="sales" items="${slist}">
                <tr>
                 ...
                 <td>${sales.productName}</td>
                  ...
                  <td>
				<input type="button" class="btn btn-success" onclick="editSalesByStaff(${sales.sales_id})" value="Edit">
					</td>
...
<script type="text/javascript">
	function editSalesByStaff(id){
		window.location="${pageContext.request.contextPath}/"+id+"/editSalesByStaff";
	}
