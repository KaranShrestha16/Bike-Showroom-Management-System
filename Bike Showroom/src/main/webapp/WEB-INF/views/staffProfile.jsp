          ...
          <div class="row">
            <div class="col-md-12" >
             ...
             <div  class="col-xs-6">
              ...
              <div class="user-footer">
               <img src="${pageContext.request.contextPath}/resources/images/${staffDetails.imageName}" height="150" width="150" class="img-circle" alt="User Image" >
              </div>
             </div>
			...
			<div class="col-xs-8">
               ...
               <tr>     
                ...
                <tr>
                <th>
               	<input type="button" class="btn btn-success" onclick="editStaffProfile(${staffDetails.id})" value="Edit Profile">
                </th>
                </tr>
...
function editStaffProfile(id){
	window.location="${pageContext.request.contextPath}/"+id+"/editStaffProfile";
}
