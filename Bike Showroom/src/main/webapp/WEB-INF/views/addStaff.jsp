  ...
  <aside class="main-sidebar">
   ...
   <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview menu-open">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="addStaff"><i class="fa fa-circle-o"></i> Add Staff</a></li>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
         ...
         <form action="staffRegister" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="brithDate" class="form-control pull-right" id="datepicker" required>
                </div>
                <!-- /.input group -->
              </div>
                 ...
                 <div class="radio">
                    <label>
                     ...
                     <label>
                      ...
                      <input type="radio" name="gender" id="optionsRadios1" value="other" >
                      Other
                    </label>
                  </div>
               </div>
