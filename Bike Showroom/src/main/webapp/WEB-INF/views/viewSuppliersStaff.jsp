       ...
       <li class=" treeview menu-open">
         ...
         <li class=" treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"> <a href="viewSuppliersStaff"><i class="fa fa-circle-o"></i> View Supplier</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="addSuppliersStaff">Supplier</a></li>
        <li >View supplier</li>
      </ol>
    </section>
             ...
             <table id="example1" class="table table-bordered table-striped">
               ...
               <c:forEach var="supplier" items="${slist}">
                <tr>
                  ...
                  <td>
				<input type="button" class="btn btn-success" onclick="editSupplier(${supplier.supplier_id})" value="Edit">
				</td>
...
<script type="text/javascript">
	function editSupplier(id){
		window.location="${pageContext.request.contextPath}/"+id+"/editSupplier";
	}
	function deleteSupplier(id){
		var msg=confirm("do you want to delete ? ");
		if(msg==true){
			window.location="${pageContext.request.contextPath}/"+id+"/deleteSupplier";
		}
	}
