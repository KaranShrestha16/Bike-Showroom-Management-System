       ...
       <li class="  treeview menu-open">
         ...
         <li class=" active treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active" ><a href="salesReport"><i class="fa fa-circle-o"></i> Sales Report</a></li>
          </ul>
        </li>    
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><ahref="purchaseReport" >Report</a></li>
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
           ...
           <form action="generateSalesReport" method="post">
           <div class="col-xs-3">
          
           </div><div class="col-xs-8">
           <h2>Choose Date To Generate Report</h2>
           </div>
           <div class="col-xs-3">
            ...
            <div class="col-xs-3">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="fromDate" class="form-control pull-right" id="datepicker" required>
                </div>
                <!-- /.input group -->
              </div>
              <div class="col-xs-3">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="toDate" class="form-control pull-right" id="datepicker" required>
                </div>
                <!-- /.input group -->
              </div>
              <div class="col-xs-5">
