       ...
       <li class=" treeview menu-open">
        ...
        <li class=" active treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="viewCustomerAdmin"><i class="fa fa-circle-o"></i> View Customer</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="addCustomerStaff">Customer</a></li>
        <li >View Customer</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
               <c:forEach var="customer" items="${slist}">
                <tr>
                  ...
                  <td>
				<input type="button" class="btn btn-success" onclick="editCustomerByAdmin(${customer.customer_id})" value="Edit">
				<input type="button" class="btn btn-danger" onclick="deleteCustomerByAdmin(${customer.customer_id})" value="Delete">
				</td>
...
<script type="text/javascript">
	function editCustomerByAdmin(id){
		window.location="${pageContext.request.contextPath}/"+id+"/editCustomerByAdmin";
	}
	function deleteCustomerByAdmin(id){
		var msg=confirm("do you want to delete ? ");
		if(msg==true){
			window.location="${pageContext.request.contextPath}/"+id+"/deleteCustomerByAdmin";
		}
	}
